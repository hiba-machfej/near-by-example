    ...
    <>
      ...
      {copyCodeStatus === 'copied' && (
        <div className="absolute bottom-full left-1/2 mb-3.5 pb-1 -translate-x-1/2">
          <div className="relative bg-darkGreen text-white font-mono text-[0.625rem] leading-6 font-medium px-1.5 rounded-lg" data-reach-alert="true">
            Copied
            <svg aria-hidden="true" width="16" height="6" viewBox="0 0 16 6" className="text-darkGreen absolute top-full left-1/2 -mt-px -ml-2">
